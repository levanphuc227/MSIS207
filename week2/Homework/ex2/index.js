...
function makeSound(key) {
  switch (key) {
    case "2": {
      let baochay  = new Audio("sounds/Tieng-chuong-bao-chay.mp3");
      baochay.play();
      break;
    }
    case "3": {
      let tom1 = new Audio("sounds/Tieng-coi-xe-canh-sat.mp3");
      tom1.play();
      break;
    }
    case "4": {
      let tom1 = new Audio("Tieng-coi-xe-cuu-hoa.mp3");
      tom1.play();
      break;
    }
    case "5": {
      let tom1 = new Audio("sounds/Tieng-coi-xe-cap-cuu.mp3");
      tom1.play();
      break;
    }
    case "w": {
